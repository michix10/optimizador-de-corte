...
import { Panel, EdgeBanding, PlacedPiece } from '../types.ts';
import { generateCutList } from '../services/cutlistGenerator.ts';
import CutListDisplay from './CutListDisplay.tsx';
  ...
  useLayoutEffect(() => {
    const calculateScale = () => {
      if (containerRef.current) {
        ...
        // Add some padding
        const newScale = (containerWidth - 40) / panel.width;
        setScale(newScale);
      }
    };
...
export default ResultDisplay;        setCutPieces(new Set());
    }
  };
